...
export const SNV_ROLE_ACTION_RULES = {
  [SNV.DREAMER]: {
    ...
    allowDead: false,
    minNight: 1,
    prompt: "选择 1 名玩家，得知 ta 可能是两个角色中的哪一个。",
    interaction: {
      title: "筑梦师的窥梦",
      subtitle: "选择一名玩家，Storyteller 会给出一真一假两个角色。",
      style: "divination",
      badge: "一真一假",
      helper: "若你中毒/醉酒，答案可能被 Storyteller 改写为误导信息。",
      confirmText: "进入梦境",
      skipText: "让系统代选",
    },
  },
  [SNV.SNAKE_CHARMER]: {
    ...
    allowDead: false,
    minNight: 1,
    prompt: "选择 1 名玩家；若 ta 是恶魔，你们交换角色和阵营。",
    interaction: {
      title: "舞蛇人的试探",
      subtitle: "选择一名玩家。如果选中恶魔，你会变成恶魔，原恶魔变成中毒的舞蛇人。",
      style: "danger",
      badge: "交换风险",
      helper: "这是强交互角色：本地引擎会立刻修改角色、阵营与认知记录。",
      confirmText: "催眠此人",
      skipText: "让系统代选",
    },
  },
  [SNV.SEAMSTRESS]: {
    ...
    interaction: {
      title: "女裁缝的针线",
      subtitle: "选择两名玩家，判断他们是否同阵营。",
      style: "divination",
      badge: "一次能力",
      helper: "这是一次性能力。若你中毒/醉酒，结果可能被反转或改写。",
      confirmText: "缝合线索",
      skipText: "暂不使用",
    },
  },
  ...
  [SNV.WITCH]: {
    ...
    allowDead: false,
    minNight: 1,
    prompt: "选择 1 名玩家施加诅咒；若 ta 明天提名，ta 会死亡。",
    interaction: {
      title: "女巫的诅咒",
      subtitle: "选择一名玩家。该玩家若在明天提名，会立即死亡。",
      style: "danger",
      badge: "提名即死",
      helper: "诅咒不会直接公开。AI 只会通过死亡事件和发言推断。",
      confirmText: "施加诅咒",
      skipText: "让系统代选",
    },
  },
  [SNV.CERENOVUS]: {
    ...
    interaction: {
      title: "洗脑师的命令",
      subtitle: "选择一名玩家和一个角色；ta 明天若不按要求声称，可能被处决。",
      style: "control",
      badge: "玩家+角色",
      helper: "适合迫使关键位乱报，也能制造假信息链。",
      confirmText: "下达命令",
      skipText: "让系统代选",
    },
  },
  [SNV.PIT_HAG]: {
    ...
    interaction: {
      title: "麻脸巫婆的改造",
      subtitle: "选择玩家和新角色。若创造恶魔，Storyteller 可能当晚制造死亡保护平衡。",
      style: "control",
      badge: "变更角色",
      helper: "这是高复杂度改局势能力。当前会记录角色变化并触发相关认知更新。",
      confirmText: "改写身份",
      skipText: "让系统代选",
    },
  },
  [SNV.FANG_GU]: {
    ...
    allowDead: false,
    minNight: 2,
    prompt: "选择 1 名存活玩家作为方古击杀目标。",
    interaction: {
      title: "方古的寄生",
      subtitle: "若首次杀死外来者，方古可能跳转到该外来者身上，原方古死亡。",
      style: "danger",
      badge: "首次外来者",
      helper: "外来者局会显著改变邪恶伪装策略；AI 会更重视外来者声明。",
      confirmText: "夜袭此人",
      skipText: "让系统代选",
    },
  },
  [SNV.VIGORMORTIS]: {
    ...
    allowDead: false,
    minNight: 2,
    prompt: "选择 1 名存活玩家作为亡骨魔击杀目标。",
    interaction: {
      title: "亡骨魔的献祭",
      subtitle: "被你杀死的爪牙会保留能力，但邻近镇民中毒。",
      style: "danger",
      badge: "爪牙献祭",
      helper: "当前引擎会尽量保留死亡爪牙能力，并标记相邻中毒来源。",
      confirmText: "夜袭此人",
      skipText: "让系统代选",
    },
  },
  [SNV.NO_DASHII]: {
    ...
    allowDead: false,
    minNight: 2,
    prompt: "选择 1 名存活玩家作为诺-达鲺击杀目标。",
    interaction: {
      title: "诺-达鲺的污染",
      subtitle: "你两侧最近的镇民持续中毒；夜晚选择一名玩家死亡。",
      style: "danger",
      badge: "邻近中毒",
      helper: "中毒是客观状态，不会直接暴露给主视角或 AI，除非通过信息异常推断。",
      confirmText: "夜袭此人",
      skipText: "让系统代选",
    },
  },
  [SNV.VORTOX]: {
    ...
    allowDead: false,
    minNight: 2,
    prompt: "选择 1 名存活玩家作为涡流击杀目标。",
    interaction: {
      title: "涡流的谎言",
      subtitle: "所有镇民能力都会得到错误信息；白天若无人处决，邪恶阵营获胜。",
      style: "danger",
      badge: "全局假信息",
      helper: "当前规则会尽量强制镇民信息错误，并在无处决时检查胜利。",
      confirmText: "夜袭此人",
      skipText: "让系统代选",
    },
  },
